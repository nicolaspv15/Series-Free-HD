  ...
  return (
    <div className="column">
      <div className="div2" onClick={handleShowVideo}>
        Chapter 1
        <img className="imagen" width="35" src="https://exquisite-centaur-acdf6d.netlify.app/public/play.png" onClick={handleShowVideo} />
      </div>
      ...
      {showVideo && (
        <div className="video-container">
          <video controls>
            ...
            <source src="https://exquisite-centaur-acdf6d.netlify.app/public/video.mov" type="video/mp4" />
